...
if __name__ == "__main__":
    ...
    with Manager() as manager:
        ...
        panD = manager.Value("f", 0.002) # Try to keep these an order of magnitude lower than your P and I values

        # PID values for tilting
        tiltP = manager.Value("f", 0.09) 
        tiltI = manager.Value("f", 0.22)
        tiltD = manager.Value("f", 0.001) # Try to keep these an order of magnitude lower than your P and I values
